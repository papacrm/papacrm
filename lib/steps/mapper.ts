...
// rename, combine, or hard-code fields from whatever the previous step left
...
function applyMapping(mapping: unknown, ctx: StepContext): Record<string, any> {
