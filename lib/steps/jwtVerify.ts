...
// A branch step (like Condition — see condition.ts): "true" if the token's
...
// in the workflow document or the editor's UI.
const jwtVerifyStep: StepExecutor = {
    run({ node, ctx, edges }) {
