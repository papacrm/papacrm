...
const jwtSignNode: ModuleNodeDef = {
    type: "jwtSign",
    label: "JWT Sign",
    description: "Signs a JSON payload into a token, using data from an earlier node",
    color: "#9f1239",
    kind: "action",
    fields: [
        {
            key: "payload",
            label: "Payload (JSON) — use {{field}} for data from an earlier node",
            kind: "textarea",
